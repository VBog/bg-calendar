...
function json_validate(e) {
	...
	if (!event.title.trim()) {
		summary.innerHTML = '<span class="red">Ошибка: Нет назания события</span>';
		alert ('Ошибка: Нет назания события');
		return false;
	}
	if (!event.id) {
