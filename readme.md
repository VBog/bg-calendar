...
**Структура данных события календаря**
		...
		(
		  [0] => Array
			(
				...
				[level] => *уровень значимости события в соответствии со знаком Типикона (0...7), 8 - особый день*
				[top_level] => *повышенный уровень значимости события, рекомендованный в Богослужебных указаниях*
				[priority] => *приоритет отображения события*
				[type] => *тип события*
				[subtype] => *подтип события*
				[feast_type] => *тип праздника: 1 - Господский, 2 - Богородичный, 3 - святого*
				[forename] => *краткое наименование события (святого)*
				[name] => *имя святого*
	...
	***Параметры дня***
	[festivity_ind] => *Пред-/попразднство (индекс события)*
	[festivity_type] => *Тип празднства*
	[festivity_subtype] => *Подтип празднства*
	[special_ind] => *Особый день (индекс события)*
	[day_type] => *Тип дня*
	[day_subtype] => *Подтип дня*
	[main_ind] => *Индекс главного события* 
	...
	[main_rank] => *Ранк главного события (10*[main_type]+[main_level])*
	[second_ind] => *Индекс второго события* 
	[tipicon_events] => Array	*Массив индексов событий Типикона*
	[top_events] => Array	*Массив событий с повышенным уровнем значимости*
