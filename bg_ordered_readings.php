...
/*======================================================================================================
	...
	Версия 2.2
		...
		bg_day_readings ($date, $title)	- чтения дня
	Параметры:
 ...
 ========================================================================================*/
	public function bg_Gospel_at_Liturgy ($date) {
		$gl = [	'-104'=>'Мк.8:11-21','-103'=>'Мк.8:22-26','-102'=>'Мк.8:30-34','-101'=>'Мк.9:10-16','-100'=>'Мк.9:33-41','-99'=>'Лк.14:1-11','-98'=>'Лк.18:18-27',		// Повтор 30 по Пятидесятнице ****
				...
				'50'=>'Мф.18:10-20','51'=>'Мф.4:25-5:13','52'=>'Мф.5:20-26','53'=>'Мф.5:27-32','54'=>'Мф.5:33-41','55'=>'Мф.5:42-48','56'=>'Мф.10:32-33,37-38,19:27-30',	// Троицкая
				...
				'78'=>'Мф.12:9-13','79'=>'Мф.12:14-16,22-30','80'=>'Мф.12:38-45','81'=>'Мф.12:46-13:3','82'=>'Мф.13:3-9','83'=>'Мф.9:9-13','84'=>'Мф.8:28-9:1',			// 5 по Пятидесятнице	
	...
	/*Лк*/		'169'=>'Лк.3:19-22','170'=>'Лк.3:23-4:1','171'=>'Лк.4:1-15','172'=>'Лк.4:16-22','173'=>'Лк.4:22-30','174'=>'Лк.4:31-36','175'=>'Лк.5:1-11',				// 18 по Пятидесятнице
				'176'=>'Лк.4:38-44','177'=>'Лк.5:12-16','178'=>'Лк.5:33-39','179'=>'Лк.6:12-19','180'=>'Лк.6:17-23','181'=>'Лк.5:17-26','182'=>'Лк.6:31-36',			// 19 по Пятидесятнице
				...
				'197'=>'Лк.9:18-22','198'=>'Лк.9:23-27','199'=>'Лк.9:44-50','200'=>'Лк.9:49-56','201'=>'Лк.10:1-15','202'=>'Лк.7:1-10','203'=>'Лк.16:19-31',			// 22 по Пятидесятнице
				...
				'274'=>'Мк.12:13-17','275'=>'Мк.12:18-27','276'=>'Мк.12:28-37','277'=>'Мк.12:38-44','278'=>'Мк.13:1-8','279'=>'Лк.18:2-8','280'=>''];		// 33 по Пятидесятнице *
		...
		if ($date <= $end_of_cycle) {										// Завершаем круг чтения прошлого года
			...
			if ($shift_exaltation < 0 && $interval > 168)	{				// Если случилась Воздвиженская отступка, 
				...
				$key += -42;												// Вариант, используемый Патриархией в Богослужебных Указаниях (11 или 10 и 11 по Пятидесятнице)
			}
		...
		// Если есть Крещенская отступка, то в рядовые Недели исключаем повтор чтений
//		if($interval <= $interval_end_of_cycle && $interval >= $interval_end_of_cycle + $shift_еpiphany) {
//			if(!($interval%7)) $gl[$key] = '';
//		}
 ...
 ========================================================================================*/
	public function bg_Apostol_at_Liturgy ($date) {
		$al = [	'-104'=>'Евр.8:7-13','-103'=>'Евр.9:8-10,15-23','-102'=>'Евр.10:1-18','-101'=>'Евр.10:35-11:7','-100'=>'Евр.11:8,11-16','-99'=>'Еф.5:1-8','-98'=>'Кол.3:12-16',	// Повтор 30 по Пятидесятнице ****	
				...
				'-62'=>'1Ин.2:18-3:10','-61'=>'1Ин.3:10-20','-60'=>'1Ин.3:21-4:6','-59'=>'1Ин.4:20-5:21','-58'=>'2Ин.1:1-13','-57'=>'1Кор.10:23-28','-56'=>'1Кор.8:8-9:2',	// О страшном суде
				...
				'15'=>'Деян.6:8-7:5,47-60','16'=>'Деян.8:5-17','17'=>'Деян.8:18-25','18'=>'Деян.8:26-39','19'=>'Деян.8:40-9:19','20'=>'Деян.9:19-31','21'=>'Деян.9:32-42',			// 3 по Пасхе
				...
				'50'=>'Еф.5:8-19','51'=>'Рим.1:1-7,13-17','52'=>'Рим.1:18-27','53'=>'Рим.1:28-2:9','54'=>'Рим.2:14-29','55'=>'Рим.1:7-12','56'=>'Евр.11:33-12:2',					// Троицкая
				...
				'85'=>'Рим.16:17-24','86'=>'1Кор.1:1-9','87'=>'1Кор.2:9-16,3:1-8','88'=>'1Кор.3:18-23','89'=>'1Кор.4:5-8','90'=>'Рим.9:1-5','91'=>'Рим.12:6-14',						// 6 по Пятидесятнице
				...
				'274'=>'1Пет.2:21-3:9','275'=>'1Пет.3:10-22','276'=>'1Пет.4:1-11','277'=>'1Пет.4:12-5:5','278'=>'2Пет.1:1-10','279'=>'2Тим.2:11-19','280'=>''];	// 33 по Пятидесятнице *
...
/*========================================================================================
 ...
 ========================================================================================*/
	public function bg_Gospel_at_Matins ($date) {
		...
		$ascension = date_format(date_add(date_create($easter), date_interval_create_from_date_string("39 days")), 'Y-m-d');		// Вознесение
		...
		if ($is_sunday && $date < $palm_sunday) {								// До Вербного воскресенья завершаем круг чтения прошлого года
			...
			$gm_m = ['-7'=>'Мф.21:1-11,15-17','-6'=>'Мф.21:18-43','-5'=>'Мф.22:15-23:39','-4'=>'Ин.12:17-50','-3'=>'Лк.22:1-39',
					'-2'=>'Ин.13:31-18:1; Ин.18:1-28; Мф.26:57-75; Ин.18:28-19:16; Мф.27:3-32; Мк.15:16-32; Мф.27:33-54; Лк.23:32-49; Ин.19:25-37; Мк.15:43-47; Ин.19:38-42; Мф.27:62-66',
					'-1'=>'1Кор.5:6-8; Гал.3:13-14; Мф.27:62-66'];
			return $gm_m[$interval];
		} elseif ($date == $ascension) {										// Вознесение
			return 'Мк.16:9-20';
...
//			$week = $order[($interval/7-1)%11];						
			$week = ($interval/7-1)%11;		
			$gm_e = [ 'Мф.28:16-20','Мк.16:9-20','Лк.24:1-12','Ин.20:1-10','Ин.20:11-18','Ин.21:1-14','Ин.20:19-23'];
			return $gm_e[$week];
...
/*========================================================================================
	Библейские чтения на 1 Часе 
	Параметры:
		$date - дата в формате Y-m-d
	Возвращает:
		Текст, содержащий список ссылок на Библию 
 ========================================================================================*/
	public function bg_Bible_at_1Hour ($date) {
		$ot = [	
				'-55'=>'','-54'=>'','-53'=>'','-52'=>'','-51'=>'',		// Сырная 
				'-48'=>'','-47'=>'','-46'=>'','-45'=>'','-44'=>'',		// 1 Великого поста
				'-41'=>'','-40'=>'','-39'=>'','-38'=>'','-37'=>'',		// 2 Великого поста
				'-34'=>'','-33'=>'','-32'=>'','-31'=>'','-30'=>'',		// 3 Великого поста
				'-27'=>'','-26'=>'','-25'=>'','-24'=>'','-23'=>'',		// 4 Великого поста
				'-20'=>'','-19'=>'','-18'=>'','-17'=>'','-16'=>'',		// 5 Великого поста
				'-13'=>'','-12'=>'','-11'=>'','-10'=>'','-9'=>'',		// 6 Великого поста
				'-6'=>'','-5'=>'','-4'=>'','-3'=>'','-2'=>'Гал.6:14-18; Мф.27:1-56'	// Страстная
			];	


		list($year, $month, $day) = explode ('-', $date); 
		$key = $this->bg_date_easter_dif($date, $year);
		
		if (array_key_exists($key, $ot)) return $ot[$key];
		else return "";
	}
	
/*========================================================================================
	Библейские чтения на 3 Часе 
	Параметры:
		$date - дата в формате Y-m-d
	Возвращает:
		Текст, содержащий список ссылок на Библию
 ========================================================================================*/
	public function bg_Bible_at_3Hour ($date) {
		$ot = [	
				'-55'=>'','-54'=>'','-53'=>'','-52'=>'','-51'=>'',		// Сырная 
				'-48'=>'','-47'=>'','-46'=>'','-45'=>'','-44'=>'',		// 1 Великого поста
				'-41'=>'','-40'=>'','-39'=>'','-38'=>'','-37'=>'',		// 2 Великого поста
				...
				'-20'=>'','-19'=>'','-18'=>'','-17'=>'','-16'=>'',		// 5 Великого поста
				'-13'=>'','-12'=>'','-11'=>'','-10'=>'','-9'=>'',		// 6 Великого поста
				'-6'=>'','-5'=>'','-4'=>'','-3'=>'','-2'=>'Рим.5:6-11; Мк.15:16-41'	// Страстная
			];	
...
/*========================================================================================
	Библейские чтения на 6 Часе 
	Параметры:
		$date - дата в формате Y-m-d
	Возвращает:
		Текст, содержащий список ссылок на Библию
 ========================================================================================*/
	public function bg_Bible_at_6Hour ($date) {
		$ot = [	
				'-55'=>'','-54'=>'','-53'=>'Иоил.2:12-26','-52'=>'','-51'=>'Зах.8:7-17',										// Сырная 
				'-48'=>'Ис.1:1-20','-47'=>'Ис.1:19-2:3','-46'=>'Ис.2:3-11','-45'=>'Ис.2:11-21','-44'=>'Ис.3:1-14',				// 1 Великого поста
				'-41'=>'Ис.4:2-5:7','-40'=>'Ис.5:7-16','-39'=>'Ис.5:16-25','-38'=>'Ис.6:1-12','-37'=>'Ис.7:1-14',				// 2 Великого поста
				'-34'=>'Ис.8:13-9:7','-33'=>'Ис.9:9-10:4','-32'=>'Ис.10:12-20','-31'=>'Ис.11:10-12:2','-30'=>'Ис.13:2-13',		// 3 Великого поста
				'-27'=>'Ис.14:24-32','-26'=>'Ис.25:1-9','-25'=>'Ис.26:21-27:9','-24'=>'Ис.28:14-22','-23'=>'Ис.29:13-23',		// 4 Великого поста
				'-20'=>'Ис.37:33-38:6','-19'=>'Ис.40:18-31','-18'=>'Ис.41:4-14','-17'=>'Ис.42:5-16','-16'=>'Ис.45:11-17',		// 5 Великого поста
				'-13'=>'Ис.48:17-49:4','-12'=>'Ис.49:6-10','-11'=>'Ис.58:1-11','-10'=>'Ис.65:8-16','-9'=>'Ис.66:10-24',			// 6 Великого поста
				'-6'=>'','-5'=>'','-4'=>'','-3'=>'','-2'=>'Евр.2:11-18; Лк.23:32-49'	// Страстная
			];	
...
/*========================================================================================
	Библейские чтения на 9 Часе 
	Параметры:
		$date - дата в формате Y-m-d
	Возвращает:
		Текст, содержащий список ссылок на Библию
 ========================================================================================*/
	public function bg_Bible_at_9Hour ($date) {
		$ot = [	
				'-55'=>'','-54'=>'','-53'=>'','-52'=>'','-51'=>'',		// Сырная 
				'-48'=>'','-47'=>'','-46'=>'','-45'=>'','-44'=>'',		// 1 Великого поста
				'-41'=>'','-40'=>'','-39'=>'','-38'=>'','-37'=>'',		// 2 Великого поста
				...
				'-20'=>'','-19'=>'','-18'=>'','-17'=>'','-16'=>'',		// 5 Великого поста
				'-13'=>'','-12'=>'','-11'=>'','-10'=>'','-9'=>'',		// 6 Великого поста
				'-6'=>'','-5'=>'','-4'=>'','-3'=>'','-2'=>'Евр.10:19-31; Ин.18:28-19:37'	// Страстная
			];	
...
/*========================================================================================
	Библейские чтения на Вечерне
	Параметры:
		$date - дата в формате Y-m-d
	Возвращает:
		Текст, содержащий список ссылок на Библию
 ========================================================================================*/
	public function bg_Bible_at_Vespers ($date) {
		$ot = [	
				'-55'=>'','-54'=>'','-53'=>'Иоил.3:12-21','-52'=>'','-51'=>'Зах.8:19-23',		// Сырная 
				'-48'=>'Быт.1:1-13; Притч.1:1-20','-47'=>'Быт.1:14-23; Притч.1:20-33','-46'=>'Быт.1:24-2:3; Притч.2:1-22','-45'=>'Быт.2:4-19; Притч.3:1-18','-44'=>'Быт.2:20-3:20; Притч.3:19-34',		// 1 Великого поста
				'-41'=>'Быт.3:21-4:7; Притч.3:34-4:22','-40'=>'Быт.4:8-15; Притч.5:1-15','-39'=>'Быт.4:16-26; Притч.5:15-6:3','-38'=>'Быт.5:1-24; Притч.6:3-20','-37'=>'Быт.5:32-6:8; Притч.6:20-7:1',		// 2 Великого поста
				'-34'=>'Быт.6:9-22; Притч.8:1-21','-33'=>'Быт.7:1-5; Притч.8:32-9:11','-32'=>'Быт.7:6-9; Притч.9:12-18','-31'=>'Быт.7:11-8:3; Притч.10:1-22','-30'=>'Быт.8:4-21; Притч.10:31-11:12',		// 3 Великого поста
				'-27'=>'Быт.8:21-9:7; Притч.11:19-12:6','-26'=>'Быт.9:8-17; Притч.12:8-22','-25'=>'Быт.9:18-10:1; Притч.12:23-13:9','-24'=>'Быт.10:32-11:9; Притч.13:20-14:6','-23'=>'Быт.12:1-7; Притч.14:15-26',		// 4 Великого поста
				'-20'=>'Быт.13:12-18; Притч.14:27-15:4','-19'=>'Быт.15:1-15; Притч.15:7-19','-18'=>'Быт.17:1-9; Притч.15:20-16:6','-17'=>'Быт.18:20-33; Притч.16:17-17:17','-16'=>'Быт.22:1-18; Притч.17:17-18:5',		// 5 Великого поста
				'-13'=>'Быт.27:1-41; Притч.19:16-25','-12'=>'Быт.31:3-16; Притч.21:3-21','-11'=>'Быт.43:26-31,45:1-16; Притч.21:23-22:4','-10'=>'Быт.46:1-7; Притч.23:15-24:5','-9'=>'Быт.49:33-50:26; Притч.31:8-31',		// 6 Великого поста
				'-6'=>'','-5'=>'','-4'=>'','-3'=>'','-2'=>'1Кор.1:18-2:2; Мф.27:1-44; Лк.23:39-43; Мф.27:45-54; Ин.19:31-37; Мф.27:55-61',	// Страстная
				'0'=>'Ин.20:19-25'
			];	
...
/*========================================================================================
	...
	Возвращает:
		Текст, содержащий список ссылок на Библию 
 ========================================================================================*/
	public function bg_day_readings ($date, $title='') {
		$readings = (object) array();
		
		$readings->title = $title;
		$readings->morning = $this->bg_Gospel_at_Matins ($date);
		$readings->apostle = $this->bg_Apostol_at_Liturgy ($date);
		$readings->gospel = $this->bg_Gospel_at_Liturgy ($date);
		$readings->hour1 = $this->bg_Bible_at_1Hour ($date);
		$readings->hour3 = $this->bg_Bible_at_3Hour ($date);
		$readings->hour6 = $this->bg_Bible_at_6Hour ($date);
		$readings->hour9 = $this->bg_Bible_at_9Hour ($date);
		$readings->evening = $this->bg_Bible_at_Vespers ($date);
